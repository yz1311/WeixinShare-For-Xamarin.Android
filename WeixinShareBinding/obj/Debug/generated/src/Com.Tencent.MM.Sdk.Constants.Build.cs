...
namespace Com.Tencent.MM.Sdk.Constants {
	...
	public sealed partial class Build : global::Java.Lang.Object {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.sdk.constants']/class[@name='Build']/field[@name='FAVORITE_SUPPPORTED_SDK_INT']"
		[Register ("FAVORITE_SUPPPORTED_SDK_INT")]
		public const int FavoriteSuppportedSdkInt = (int) 570425345;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.sdk.constants']/class[@name='Build']/field[@name='MESSAGE_ACTION_SUPPPORTED_SDK_INT']"
		...
		[Register ("SDK_INT")]
		public const int SdkInt = (int) 570490883;
		...
		public const string SdkVersionName = (string) "android 2.1.3";
