...
namespace Com.Tencent.MM.Sdk.Openapi {
	...
	public partial class WXAPIFactory : global::Java.Lang.Object {
		...
		public static unsafe global::Com.Tencent.MM.Sdk.Openapi.IWXAPI CreateWXAPI (global::Android.Content.Context p0, string p1)
		{
			...
			try {
				...
				global::Com.Tencent.MM.Sdk.Openapi.IWXAPI __ret = global::Java.Lang.Object.GetObject<global::Com.Tencent.MM.Sdk.Openapi.IWXAPI> (JNIEnv.CallStaticObjectMethod  (class_ref, id_createWXAPI_Landroid_content_Context_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
		...
		public static unsafe global::Com.Tencent.MM.Sdk.Openapi.IWXAPI CreateWXAPI (global::Android.Content.Context p0, string p1, bool p2)
		{
			...
			try {
				...
				global::Com.Tencent.MM.Sdk.Openapi.IWXAPI __ret = global::Java.Lang.Object.GetObject<global::Com.Tencent.MM.Sdk.Openapi.IWXAPI> (JNIEnv.CallStaticObjectMethod  (class_ref, id_createWXAPI_Landroid_content_Context_Ljava_lang_String_Z, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p1);
			}
