...
namespace Com.Tencent.MM.Sdk.Modelmsg {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.tencent.mm.sdk.modelmsg']/class[@name='WXEmojiSharedObject']"
	[global::Android.Runtime.Register ("com/tencent/mm/sdk/modelmsg/WXEmojiSharedObject", DoNotGenerateAcw=true)]
	public partial class WXEmojiSharedObject : global::Java.Lang.Object, global::Com.Tencent.MM.Sdk.Modelmsg.WXMediaMessage.IMediaObject {


		static IntPtr packageflag_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.sdk.modelmsg']/class[@name='WXEmojiSharedObject']/field[@name='packageflag']"
		...
		public int Packageflag {
			get {
				...
				return JNIEnv.GetIntField (Handle, packageflag_jfieldId);
			}
			set {
				if (packageflag_jfieldId == IntPtr.Zero)
					packageflag_jfieldId = JNIEnv.GetFieldID (class_ref, "packageflag", "I");
				try {
					JNIEnv.SetField (Handle, packageflag_jfieldId, value);
				} finally {
				}
			}
		}
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.sdk.modelmsg']/class[@name='WXEmojiSharedObject']/field[@name='packageid']"
		[Register ("packageid")]
		public string Packageid {
			get {
				if (packageid_jfieldId == IntPtr.Zero)
					packageid_jfieldId = JNIEnv.GetFieldID (class_ref, "packageid", "Ljava/lang/String;");
				IntPtr __ret = JNIEnv.GetObjectField (Handle, packageid_jfieldId);
			...
			set {
				...
				try {
					JNIEnv.SetField (Handle, packageid_jfieldId, native_value);
				} finally {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.sdk.modelmsg']/class[@name='WXEmojiSharedObject']/field[@name='thumburl']"
		[Register ("thumburl")]
		public string Thumburl {
			get {
				if (thumburl_jfieldId == IntPtr.Zero)
					thumburl_jfieldId = JNIEnv.GetFieldID (class_ref, "thumburl", "Ljava/lang/String;");
				IntPtr __ret = JNIEnv.GetObjectField (Handle, thumburl_jfieldId);
				return JNIEnv.GetString (__ret, JniHandleOwnership.TransferLocalRef);
			}
			set {
				if (thumburl_jfieldId == IntPtr.Zero)
				...
				IntPtr native_value = JNIEnv.NewString (value);
				try {
					JNIEnv.SetField (Handle, thumburl_jfieldId, native_value);
				} finally {
					JNIEnv.DeleteLocalRef (native_value);
				}
			}
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.mm.sdk.modelmsg']/class[@name='WXEmojiSharedObject']/field[@name='url']"
		[Register ("url")]
		public string Url {
			get {
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/tencent/mm/sdk/modelmsg/WXEmojiSharedObject", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.mm.sdk.modelmsg']/class[@name='WXEmojiSharedObject']/constructor[@name='WXEmojiSharedObject' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (WXEmojiSharedObject)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.mm.sdk.modelmsg']/class[@name='WXEmojiSharedObject']/constructor[@name='WXEmojiSharedObject' and count(parameter)=4 and parameter[1][@type='java.lang.String'] and parameter[2][@type='int'] and parameter[3][@type='java.lang.String'] and parameter[4][@type='java.lang.String']]"
			...
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (WXEmojiSharedObject)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V", __args);
					return;
				}
				...
				SetHandle (
						...
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Ljava_lang_String_ILjava_lang_String_Ljava_lang_String_, __args);
			} finally {
...
#pragma warning disable 0169
		...
		{
			global::Com.Tencent.MM.Sdk.Modelmsg.WXEmojiSharedObject __this = global::Java.Lang.Object.GetObject<global::Com.Tencent.MM.Sdk.Modelmsg.WXEmojiSharedObject> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.CheckArgs ();
		}
#pragma warning restore 0169

		static IntPtr id_checkArgs;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.sdk.modelmsg']/class[@name='WXEmojiSharedObject']/method[@name='checkArgs' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.sdk.modelmsg']/class[@name='WXEmojiSharedObject']/method[@name='serialize' and count(parameter)=1 and parameter[1][@type='android.os.Bundle']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.sdk.modelmsg']/class[@name='WXEmojiSharedObject']/method[@name='type' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mm.sdk.modelmsg']/class[@name='WXEmojiSharedObject']/method[@name='unserialize' and count(parameter)=1 and parameter[1][@type='android.os.Bundle']]"
